...
public class BoardDao {
    ...
    public int updateBoardHits(BoardForm boardForm) throws Exception {
    	return sqlSession.selectOne(NAMESPACE + ".updateBoardHits", boardForm);
    }
    ...
    public int insertBoard(BoardForm boardForm) throws Exception {
    	return sqlSession.selectOne(NAMESPACE + ".insertBoard", boardForm);
    }
    
    /* 게시판 - 삭제 */
    public int deleteBoard(BoardForm boardForm) throws Exception {
    	return sqlSession.selectOne(NAMESPACE + ".deleteBoard", boardForm);
    }
    
    /* 게시판 - 수정 */
    public int updateBoard(BoardForm boardForm) throws Exception {
    	return sqlSession.selectOne(NAMESPACE + ".updateBoard", boardForm);
    }
}